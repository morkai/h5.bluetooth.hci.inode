...
/**
 * @param {{manufacturerSpecificData: function(Buffer, EirDataStructure)}} decoders
 */
exports.registerManufacturerSpecificDataDecoder = function(decoders)
{
  const originalDecoder = decoders.manufacturerSpecificData || function() {};

  decoders.manufacturerSpecificData = function(buffer, eirDataStructure)
  {
